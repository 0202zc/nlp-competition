...
class Test(unittest.TestCase):
    ...
    def test_diff(self):
        ...
        # 人工评定的相似度列表。
        human = [0.98, 0.96, 0.96, 0.94, 0.925, 0.9025, 0.875, 0.855, 0.7775, 0.77, 0.7625, 0.7425, 0.7375, 0.705, 0.42,
                 0.415,
                 0.29, 0.275, 0.2375,
                 0.2225, 0.2175, 0.21, 0.1575, 0.1375, 0.105, 0.105, 0.0325, 0.0275, 0.02, 0.02]
        result.append("# synonyms 分数评测 [(v%s)](https://pypi.python.org/pypi/synonyms/%s)" % (
        synonyms.__version__, synonyms.__version__))
