...
from modeling import NezhaPrefixForSequenceClassification, BertPrefixForSequenceClassification, RobertaPrefixForSequenceClassification
...
def main():
    ...
    bert_config = BertConfig.from_json_file(os.path.join(args.trained_model_dir, 'bert_config.json'))
    model = NezhaPrefixForSequenceClassification(bert_config, num_class=36)
