    ...
    if args.do_train:
        ...
        for fold, (train_index, valid_index) in enumerate(skf.split(all_label_ids, all_label_ids)):
            ...
            if args.trained_model_dir:
                ...
                model = XLNetPrefixForSequenceClassification(bert_config, num_labels=num_labels)
                utils.torch_show_all_params(model)
                utils.torch_init_model(model, os.path.join(args.bert_model, 'pytorch_model.bin'), prefix='transformer')
