...
from modeling import BertPrefixForSequenceClassification
...
def main():
    ...
    if args.do_train:
        ...
        for fold, (train_index, valid_index) in enumerate(skf.split(all_label_ids, all_label_ids)):
            ...
            tr_loss = 0
            best_f1 = 0.
            early_stop_epoch = 3  # 早停上限
            early_stop_count = 1  # 早停计数
            ...
            for _ in trange(int(args.num_train_epochs), desc="Epoch"):
                ...
                for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                    ...
                    loss_sum = model(input_ids=input_ids, token_type_ids=segment_ids, attention_mask=input_mask,
                                     position_ids=position_ids,
                ...
                for input_ids, input_mask, segment_ids, position_ids, label_ids in tqdm(valid_loader,
                                                                                        desc="Evaluating"):
                ...
                if best_f1 < eval_f1:
                    ...
                    resp = requests.post("https://www.autodl.com/api/v1/wechat/message/push",
                                         json={
                                             ...
                                             "title": "小样本分类",
                                             "name": "实验室服务器",
                                             "content": "Epoch: " + str(num_epoch) + " Fold: " + str(
                                                 fold) + " Best F1: " + str(best_f1)
                                         })
                    ...
                    early_stop_count += 1
                    # 如果连续 early_stop_count 次都没有效果提升，则结束本次 fold
