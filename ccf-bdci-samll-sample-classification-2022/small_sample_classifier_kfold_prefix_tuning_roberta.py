...
from modeling import RobertaPrefixForSequenceClassification, RobertaPromptForSequenceClassification
    ...
    if args.do_train:
        ...
        for fold, (train_index, valid_index) in enumerate(skf.split(all_label_ids, all_label_ids)):
            ...
            if args.trained_model_dir:
                ...
                model = RobertaPrefixForSequenceClassification(bert_config, num_class=num_labels)
                # model = NezhaPrefixForSequenceClassification(bert_config, num_class=num_labels)
