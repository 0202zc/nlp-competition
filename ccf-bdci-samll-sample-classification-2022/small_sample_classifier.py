...
def main():
    ...
    if args.do_train:
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            eval_precision = precision_score(y_true=val_true, y_pred=results, average='binary', zero_division='warn')
            eval_recall = recall_score(y_true=val_true, y_pred=results, zero_division='warn')
            eval_f1 = f1_score(y_true=val_true, y_pred=results)
