...
from modeling import NezhaForPretrain
from modeling_nezha_ccks2022 import BertConfig, WEIGHTS_NAME, CONFIG_NAME
from optimization import BertAdam, warmup_linear
from sklearn.metrics import precision_score, recall_score, f1_score

# from transformers import NezhaModel, BertTokenizer

logging.basicConfig(filename='./log/ccks2022-train-%s.log' % (strftime('%Y-%m-%d-%H-%M-%S', localtime(time()))),
                    encoding='utf8',
...
def main():
    ...
    if args.trained_model_dir:
        ...
        model = NezhaForPretrain(bert_config)
    ...
    if args.do_train:
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            # torch.save(model_to_save, "./trained_models/ccks2022/pytorch_model.bin")
